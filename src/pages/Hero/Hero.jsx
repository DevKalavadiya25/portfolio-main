...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'Devang Kalavadiya',
    title: 'Full-Stack Developer | Front-End Developer & UI/UX Designer | Problem Solver',
    skills: [
        'React',  'Redux', 'Express',
         'MongoDB', 'Html5', 'Css3', 'Bootstrap5', 'TailwindCSS',
        'JavaScript', 'Node.js',
        'J-Query', 'Git','GitHub', 'Figma', 'Photoshop'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    ...
    hireable: function() {
        return (
            ...
            this.yearsOfExperience >= FreshersExperience
        );
    }
};
  `);
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Front-End lover 🚀 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/DevKalavadiya25"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1O2c4zKUvf9LA20znEaAGGpVrL-iOCyvz/view?usp=sharing"
